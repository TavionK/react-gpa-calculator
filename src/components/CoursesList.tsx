    ...
    <section className="mt-10">
      ...
      <div className="flex gap-4 my-4">
        <button
          ...
          className="flex justify-center gap-2 basis-3/4 cursor-pointer p-2 sm:p-4 rounded-md bg-charged-yellow text-black font-semibold hover:bg-charged-yellow-dark transition-colors duration-300 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-charged-yellow focus-visible:ring-offset-4 focus-visible:ring-offset-gray-950"
        >
          <Plus />
          Add Course
        </button>
